  ...
  return (
    <>
      <style>{`
        ...
        .hero-welcome {
          font-size: clamp(4.0rem, 3vw, 2rem);
          font-weight: 600;
            ...
            <div className="hero-text">
              ...
              >
                <h1 className="hero-title">
                  <span className="hero-welcome">Our Startups At</span>
                  <motion.span
                ...
                >
                  Explore the impactful initiatives designed to uplift and empower our vibrant community of innovators and entrepreneurs.
From mentorship programs to startup accelerators, each effort fuels growth, creativity, and real-world change.
Be inspired by the drive, collaboration, and vision that turn bold ideas into lasting impact.
                </motion.p>
                </motion.div>
              </div>
            </div>
