            ...
            <div className="hero-text">
              ...
              >
                <h1 className="hero-title">
                  <span className="hero-welcome">Launch Your Career in</span>
                  <motion.span
                ...
                >
                 Level up your skills through our immersive, hands-on programs designed to challenge and inspire.
Gain practical experience, learn from industry leaders, and explore cutting-edge tools and techniques.
Whether you're just starting out or aiming to advance, there’s a path for every learner to grow.
                </motion.p>
                </motion.div>
              </div>
            </div>
