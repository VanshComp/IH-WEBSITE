            ...
            <div className="hero-text">
              ...
              >
                <h1 className="hero-title">
                  <span className="hero-welcome">Our Vision at</span>
                  <motion.span
                ...
                >
                  Empowering the next generation of bold innovators and visionary entrepreneurs to shape the future.
Through hands-on learning, mentorship, and real-world challenges, we ignite passion and purpose.
Our community fosters growth, resilience, and the confidence to turn ideas into impact.
                </motion.p>
                ...
                >
                  <a href="#contact" className="btn btn-outline" onClick={() => setIsModalOpen(true)}>
                    Get Started
                  </a>
                </motion.div>
                <ApplicationModal
