            ...
            <div className="hero-text">
              ...
              >
                <h1 className="hero-title">
                  <span className="hero-welcome">Our Projects At</span>
                  <motion.span
                ...
                >
                  Discover the groundbreaking projects and creative solutions developed by our talented community members.
Explore a diverse range of ideas from tech innovations to artistic expressions that push boundaries and inspire.
Celebrate the passion, skill, and collaboration that make our community a hub of innovation and excellence.
                </motion.p>
                </motion.div>
              </div>
            </div>
