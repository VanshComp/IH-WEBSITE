            ...
            <div className="hero-text">
              ...
              >
                <h1 className="hero-title">
                  <span className="hero-welcome">Our Events At </span>
                  <motion.span
                ...
                >
                 Join our exciting events, immersive workshops, and thrilling competitions
designed to spark creativity, build skills, and ignite your passion.
Connect with like-minded individuals, grow your network, and unlock new opportunities.
                </motion.p>
                </motion.div>
              </div>
            </div>
