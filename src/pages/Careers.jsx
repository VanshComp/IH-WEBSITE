      ...
      <section className="hero-section" ref={heroRef}>
        <div className="hero-background">
          ...
          <div className="hero-content">
            <h1 className="hero-title">Join the Innovation Revolution</h1>
            <p className="hero-subtitle">
            Join a team where bold ideas become world-changing innovations. At the heart of everything we do is a mission to build groundbreaking products that push the boundaries of what's possible. Here, you'll collaborate with brilliant, driven individuals who challenge the status quo and inspire each other to reach new heights.
            {/* Shape the future with us. Build groundbreaking products, work with brilliant minds, and make an impact that matters. */}
            </p>
